...
import { analyzeCustomLandPlot, calculateBearing, getCompassDirection, generateMonthlyIrradianceAndYield } from '../utils/geoUtils';
...
export const CustomLandCalculator: React.FC<CustomLandCalculatorProps> = ({
  ...
  const handleTriggerCustomAIReport = () => {
    ...
    const customLand: LandParcel = {
      ...
      lotNumber: `Custom Lot ${Math.floor(Math.random() * 9000 + 1000)}`,
      mukim: `Mukim ${analysis.nearestPMU.name}`,
      district: `${analysis.nearestPMU.state} Central`,
      ...
      ...generateMonthlyIrradianceAndYield(analysis.ghiKwhM2Year, analysis.maxSolarCapacityMW, Math.round(analysis.maxSolarCapacityMW * 1420)),
      ...
      capacityFactorYear1: 18.2,
      capacityFactorYear21: 16.6,
      clearsCapacityFactorFloor: true,
      bidBondMyr: is33kV ? 0.5 : (analysis.maxSolarCapacityMW > 125 ? 3.0 : 1.0),
      ...
      bidBondCapExMyr: is33kV ? 0.5 : analysis.bidBondCapExMyr,
      ghiKwhM2Year: analysis.ghiKwhM2Year,
      ghiKwhM2Day: analysis.ghiKwhM2Day,
      estimatedAnnualMWh: Math.round(analysis.maxSolarCapacityMW * 1420),
      ...
      annualCarbonOffsetTonnes: Math.round(analysis.maxSolarCapacityMW * 1420 * 0.63),
      scoreDistancePMU: Math.max(10, Math.round(100 - analysis.distanceToNearestPMUKm * 8)),
      scoreLandSize: 90,
      scoreTerrainSlope: analysis.terrainSlope < 3 ? 98 : 75,
